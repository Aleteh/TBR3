...
function GameMode:PostLoadPrecache()
	...
	PrecacheUnitByNameAsync("aris_ghost",function(...) end)
	PrecacheUnitByNameAsync("bullroarer_the_twisted",function(...) end)
	PrecacheUnitByNameAsync("cyclops",function(...) end)
	PrecacheUnitByNameAsync("darnek_the_wanderer",function(...) end)
	PrecacheUnitByNameAsync("forest_terror",function(...) end)
	PrecacheUnitByNameAsync("gethos_the_mighty",function(...) end)
	PrecacheUnitByNameAsync("heiros_darkfriend",function(...) end)
	PrecacheUnitByNameAsync("hillcrusher",function(...) end)
	PrecacheUnitByNameAsync("hulking_ice_beast",function(...) end)
	PrecacheUnitByNameAsync("lucus_farblaze",function(...) end)
	PrecacheUnitByNameAsync("mance_swiftsword",function(...) end)
	PrecacheUnitByNameAsync("nasty_big_pointy_teeth",function(...) end)
	PrecacheUnitByNameAsync("rockwatcher_felblade",function(...) end)
	PrecacheUnitByNameAsync("rokthul",function(...) end)
	PrecacheUnitByNameAsync("sea_giant",function(...) end)
	PrecacheUnitByNameAsync("the_black_knight",function(...) end)
	PrecacheUnitByNameAsync("the_dark_knight",function(...) end)
	PrecacheUnitByNameAsync("titan_Avatar_of_Death",function(...) end)
	PrecacheUnitByNameAsync("titan_Avatar_of_Earth",function(...) end)
	PrecacheUnitByNameAsync("titan_Avatar_of_Justice",function(...) end)
	PrecacheUnitByNameAsync("titan_Avatar_of_Nature",function(...) end)
	PrecacheUnitByNameAsync("titan_Avatar_of_Sacrifice",function(...) end)
	PrecacheUnitByNameAsync("titan_Avatar_of_the_Sea",function(...) end)
	PrecacheUnitByNameAsync("titan_Avatar_of_the_Sky",function(...) end)
	PrecacheUnitByNameAsync("titan_Mother_of_Earth",function(...) end)
